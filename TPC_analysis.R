...
sum_temp <- read.csv("Kelso_Reef_water_temperature.csv", sep = ",")
...
Gmax_prior <- ggplot() +
  geom_density(aes(x = posterior_samples(mod)$b_Gmax_SpeciesAcroporahyacinthus),
               fill = "#999999", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_Gmax_SpeciesAcroporatenuis),
               fill =  "#E69F00", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_Gmax_SpeciesPocilloporaverrucosa),
               fill =  "#56B4E9", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_Gmax_SpeciesStylophorapistillata),
               fill =  "#009E73", alpha = 0.7) +
  geom_density(aes(x = rnorm(10000, mean = 0, sd = 10)), col = "red", size = 1.2) +
  theme_bw() +
  ylab("Density") +
  xlab(expression(G[max])) +
  theme(text = element_text(size = 15))
Gmax_prior

rho_prior <- ggplot() +
  geom_density(aes(x = posterior_samples(mod)$b_ro_SpeciesAcroporahyacinthus),
               fill = "#999999", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_ro_SpeciesAcroporatenuis),
               fill =  "#E69F00", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_ro_SpeciesPocilloporaverrucosa),
               fill =  "#56B4E9", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_ro_SpeciesStylophorapistillata),
               fill =  "#009E73", alpha = 0.7) +
  geom_density(aes(x = rnorm(10000, mean = 0, sd = 5)), col = "red", size = 1.2) +
  theme_bw() +
  ylab("Density") +
  xlab(expression(rho)) +
  theme(text = element_text(size = 15))
...
Tshift_prior <- ggplot() +
  geom_density(aes(x = posterior_samples(mod)$b_xshift_SpeciesAcroporahyacinthus),
               fill = "#999999", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_xshift_SpeciesAcroporatenuis),
               fill =  "#E69F00", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_xshift_SpeciesPocilloporaverrucosa),
               fill =  "#56B4E9", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_xshift_SpeciesStylophorapistillata),
               fill =  "#009E73", alpha = 0.7) +
  geom_density(aes(x = rnorm(10000, mean = 25, sd = 10)), col = "red", size = 1.2) +
  theme_bw() +
  ylab("Density") +
  xlab(expression(T[shift])) +
  theme(text = element_text(size = 15))
Tshift_prior

sigma_prior <- ggplot() +
  geom_density(aes(x = posterior_samples(mod)$b_sigm_SpeciesAcroporahyacinthus),
               fill = "#999999", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_sigm_SpeciesAcroporatenuis),
               fill =  "#E69F00", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_sigm_SpeciesPocilloporaverrucosa),
               fill =  "#56B4E9", alpha = 0.7) +
  geom_density(aes(x = posterior_samples(mod)$b_sigm_SpeciesStylophorapistillata),
               fill =  "#009E73", alpha = 0.7) +
  geom_density(aes(x = rnorm(10000, mean = 0, sd = 5)), col = "red", size = 1.2) +
  theme_bw() +
  ylab("Density") +
...
ggarrange(Gmax_prior + ggtitle("a"), 
          Tshift_prior + ylab("") + ggtitle("b"),
          rho_prior + ggtitle("c"),
          sigma_prior + ylab("") + ggtitle("d"), ncol = 2)
...
lines_sp <- c(1,5, 3,6)
names(lines_sp) <- c("Acropora hyacinthus", "Acropora tenuis", 
                     "Pocillopora verrucosa", "Stylophora pistillata")
...
Fig1 <-
  ...
  geom_line(data = d_Kelso, aes(x = Temperature, y = Estimate, col = Species,
                                linetype = Species), size = 1.2) +
  theme_bw() +
  ...
  scale_fill_viridis(option = "C", direction = -1,
                     name = "Days per year") +
  scale_linetype_manual(values = lines_sp) + guides(linetype = "none")
...
names(shapes) <- c("Acropora hyacinthus", "Acropora tenuis", 
                     "Pocillopora verrucosa", "Stylophora pistillata")

# Plot initial weight
ggplot(d[d$Reef == "Kelso" & !d$Species == "plug" , ], aes( x = Species, y = Initial_weight)) +
  geom_jitter(aes(fill = Species, shape = Species), width = 0.2, height = 0,
              size = 3, alpha = 0.5) +
  ...
  xlab("") +
  ylab("Initial dry weight (g)") +
  scale_x_discrete( limits = c("Acropora hyacinthus", "Acropora tenuis",
                               "Stylophora pistillata", "Pocillopora verrucosa"),
                    labels = c(expression(italic("Acropora hyacinthus")),
                               expression(italic("Acropora tenuis")),
                               expression(italic("Stylophora pistillata")),
                               expression(italic("Pocillopora verrucosa")))) +
...
FigS5 <-
  ...
  geom_jitter(data = d[d$Reef == "Kelso", ], aes(x = Temperature, y = Growth, 
               ...
               size = 2, alpha = 0.2, height = 0,
              width = 0.2) +
  geom_line(data = d_Kelso, aes(x = Temperature, y = Estimate, col = Species,
                                linetype = Species), size = 1.1,
            alpha = 0.8) +
  theme_bw() +
  scale_colour_manual(values = colours, name = "", 
                      breaks = c("Acropora hyacinthus", "Acropora tenuis",
  ...
  scale_shape_manual(values = shapes, name = "", 
                     limits = c("Acropora hyacinthus", "Acropora tenuis",
                                "Pocillopora verrucosa", "Stylophora pistillata"),
                     labels = c(expression(italic("Acropora hyacinthus")),
                                expression(italic("Acropora tenuis")),
                                expression(italic("Pocillopora verrucosa")),
...
plot_raw <-
  ...
  geom_line(data = d_Kelso,
            ...
            linetype = "dotted") +
  geom_line(data = d_Kelso,
            aes(x = Temperature, y = Estimate, col = Species, linetype = Species), size = 1.5) +
  geom_jitter(data = d[d$Reef == "Kelso", ],
              aes(x = Temperature, y = Growth, fill = Species, shape = Species), 
  ...
  scale_linetype_manual(values = lines_sp) + guides(linetype = "none") +
  scale_shape_manual(values = shapes) + guides(linetype = "none") 
plot_raw
...
therm_br_fun <- function( rho, sigma, xshift,  prop, Gmax) {
  ...
  max_growth <- max(prop_growth) * Gmax
...
get_post_dist_Tbr <- function( Species, Reef, prop1, temps) {
  ...
  for (j in 1:length(Gmax)) {
    ...
    Topt[j]       <- outputs$Topt
    Max_growth[j] <- outputs$Max_growth
  ...
  sum_df <- df %>% 
    ...
    dplyr::summarise(
      ...
      "Max_growth"     = quantile(Max_growth,  0.500, na.rm = TRUE),
      "Max_growth_lwr" = quantile(Max_growth,  0.025, na.rm = TRUE),
      "Max_growth_upr" = quantile(Max_growth,  0.975, na.rm = TRUE)
    )
...
Fig1 <- Fig1 +
  ...
  geom_text(data = days_Species, aes(y = -0.4 - y_val, x = Tmax_upr + 0.6, 
            ...
            show_legend = FALSE)
Fig1
#saveRDS(Fig1, "Fig1_Nov.rds")


# Get correlation between Maximum growth and Topt
...
colnames(Topts) <- c("Topt_Ahyacinthus", "Topt_Atenuis", "Topt_Pverrucosa",
                     "Topt_Spistillata")
Mgrowth <- cbind(tbr_AH_K$all_values$Max_growth, tbr_AT_K$all_values$Max_growth,
               tbr_PV_K$all_values$Max_growth, tbr_SP_K$all_values$Max_growth)
colnames(Mgrowth) <- c("Max_growth_Ahyacinthus", "Max_growth_Atenuis", "Max_growth_Pverrucosa",
                       "Max_growth_Spistillata")
all_draws <- as.data.frame(cbind(Mgrowth, Topts))

cor_df <- data.frame(r = NA, p = NA, draw = NA, intercept = NA, slope = NA)

for (j in 1:nrow(all_draws)) {
  df_cor <- data.frame("Mgrowth" = c(all_draws$Max_growth_Ahyacinthus[j],
                                     all_draws$Max_growth_Atenuis[j],
                                     all_draws$Max_growth_Pverrucosa[j],
                                     all_draws$Max_growth_Spistillata[j]),
                       "Topt" =    c(all_draws$Topt_Ahyacinthus[j],
                                    all_draws$Topt_Atenuis[j],
                                    all_draws$Topt_Pverrucosa[j],
                                    all_draws$Topt_Spistillata[j]))
  m <- lm(df_cor$Mgrowth ~ df_cor$Topt)
  cor_j <- cor.test(df_cor$Mgrowth, df_cor$Topt)
  cor_df[j, ] <- c( cor_j$estimate,  cor_j$p.value,  j, coef(m)[1], coef(m)[2])
  
}


df_sum <- data.frame("Mgrowth" = c(all_draws$Max_growth_Ahyacinthus[j],
                                   all_draws$Max_growth_Atenuis[j],
                                   all_draws$Max_growth_Pverrucosa[j],
                                   all_draws$c[j]),
...
quantile(cor_df$r, c(0.025, 0.5, 0.975))
...
summary_df <- data.frame("Species" = c("Acropora hyacinthus",
                         ...
                         "Mgrowth" = c(
                           quantile(all_draws$Max_growth_Ahyacinthus, 0.5),
                           quantile(all_draws$Max_growth_Atenuis, 0.5),
                           quantile(all_draws$Max_growth_Pverrucosa, 0.5),
                           quantile(all_draws$Max_growth_Spistillata, 0.5)
                         ),
                         "Mgrowth_lwr" = c(
                           quantile(all_draws$Max_growth_Ahyacinthus, 0.025),
                           quantile(all_draws$Max_growth_Atenuis, 0.025),
                           quantile(all_draws$Max_growth_Pverrucosa, 0.025),
                           quantile(all_draws$Max_growth_Spistillata, 0.025)
                         ),
                         "Mgrowth_upr" = c(
                           quantile(all_draws$Max_growth_Ahyacinthus, 0.975),
                           quantile(all_draws$Max_growth_Atenuis, 0.975),
                           quantile(all_draws$Max_growth_Pverrucosa, 0.975),
                           quantile(all_draws$Max_growth_Spistillata, 0.975)
                         ),
                         "Topt" = c(
...
plot_4A <- ggplot() +
  ...
  geom_linerange(data = summary_df,
                 aes(x = Topt, ymin = Mgrowth_lwr, ymax = Mgrowth_upr, col = Species),
                 size = 2, alpha = 0.6) +
  geom_linerangeh(data = summary_df,
                  aes(xmin = Topt_lwr, xmax = Topt_upr, y = Mgrowth, col = Species),
                  size = 2, alpha = 0.6) +
  geom_point(data = summary_df,
             aes(x = Topt, y = Mgrowth, fill = Species, shape = Species), 
              col = "black", size = 5) +
  theme_bw()+
  theme_bw() +
  scale_colour_manual(values = colours, name = "", 
  ...
  scale_shape_manual(values = shapes, name = "", 
                     ...
                     labels = c(expression(italic("Acropora hyacinthus")),
                                ...
                                expression(italic("Pocillopora verrucosa")),
                                expression(italic("Stylophora pistillata")))) +
  ylab(expression(paste("Maximum growth ","  (mg ", g^-1, d^-1, ")"))) +
...
for (i in rand_rows) {
  ...
  for (j in 1:length(colonies)) {
    ...
    if (xshift > 0) {
      ...
      Max_growth_colony <- breadth_colony$Max_growth
      ...
      Topt_colony <- NA
      Thigh_colony <- NA
      Max_growth_colony <- NA
      
    }
    
    
    
    var_df_t <- data.frame("Parameter" = c("Mgrowth", "Topt", 
                                           "Tbr", "Thigh"),
                           "Species" = rep(Species, 4),
                           "Colony" = rep(colonies[j], 4),
                           "Var" = c(Max_growth - Max_growth_colony,
                                     Topt - Topt_colony,
                                     Tbr - Tbr_colony,
                                     Thigh - Thigh_colony),
                           "Rel_var" = c((Max_growth - Max_growth_colony) / Max_growth,
...
plot_2B <-
  ...
  geom_point(position = position_dodge2(width = 0.7),
             aes(shape = Species),  col = "black",
             alpha = 0.5, size = 2) + 
  geom_linerange(position = position_dodge2(width = 0.7), alpha = 0.5) +
  scale_x_discrete(limits = c("Mgrowth", "Topt", "Tbr"),
                   labels = c(expression(paste("Maximum growth ", " (mg ", g^-1, d^-1, ")"),
                                         paste(T[opt], " (°C)"),
                                         paste(T[br], " (°C)")))) +
  theme_bw() +
  theme(legend.position = "none") +
...
plot_2B_supplementary <-
  ...
  geom_linerange(position = position_dodge2(width = 0.7), alpha = 0.5) +
  scale_x_discrete(limits = c("Mgrowth", "Topt", "Tbr"),
                   labels = c(expression("Maximum growth", T[opt],
                                         T[br]))) +
  theme_bw() +
  theme(legend.position = "none") +
  xlab("") +
...
Estimates_derived <-
  data.frame("Variable" = c(rep("Topt", 4),
             ...
             "Estimate" = c(median(tbr_AH_K$all_values$Topt),
                            ...
                            median(tbr_AH_K$all_values$Max_growth),
                            median(tbr_AT_K$all_values$Max_growth),
                            median(tbr_PV_K$all_values$Max_growth),
                            median(tbr_SP_K$all_values$Max_growth)),
             "S.D." = c(sd(tbr_AH_K$all_values$Topt),
                        ...
                        sd(tbr_AH_K$all_values$Max_growth),
                        sd(tbr_AT_K$all_values$Max_growth),
                        sd(tbr_PV_K$all_values$Max_growth),
                        sd(tbr_SP_K$all_values$Max_growth)),
             "Lower"= c(quantile(tbr_AH_K$all_values$Topt, 0.025),
                        ...
                        quantile(tbr_AH_K$all_values$Max_growth, 0.025),
                        quantile(tbr_AT_K$all_values$Max_growth, 0.025),
                        quantile(tbr_PV_K$all_values$Max_growth, 0.025),
                        quantile(tbr_SP_K$all_values$Max_growth, 0.025)),
             "Upper"= c(quantile(tbr_AH_K$all_values$Topt, 0.975),
                        ...
                        quantile(tbr_AH_K$all_values$Max_growth, 0.975),
                        quantile(tbr_AT_K$all_values$Max_growth, 0.975),
                        quantile(tbr_PV_K$all_values$Max_growth, 0.975),
                        quantile(tbr_SP_K$all_values$Max_growth, 0.975)))
